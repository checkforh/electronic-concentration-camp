US Government Use of Electron Spin and Satellite Mind Control
...
--------------------------------------------------------------------------------
Sources: Surveillance, Mind Control, and Directed Energy
Briefing Document: Analysis of Provided Sources
This briefing document synthesizes the main themes, important ideas, and facts presented across the provided excerpts. The sources touch upon diverse subjects, including surveillance technology, the electrical nature of the human body, psychological manipulation, conspiracy theories surrounding mind control and directed energy weapons, and personal accounts of alleged harassment and technological attacks.
I. Surveillance and Information Gathering:
•
Theme: Advanced technology for remote analysis and mass surveillance.
•
Key Idea/Fact: The novel "1996" posits the existence of advanced NSA/DoD technology capable of remotely analyzing objects (organic and man-made) based on their electrical activity and electromagnetic fields.
◦
Quote: "Signals Intelligence is based on the fact that every thing in the environment, with an electric current in it, has a magne: ic flux around it which gives off EMF waves. The NSA/DoD t= Addendum developed proprietary advanced digital equipment which can remotely analyze all objects, whether man-made or organic, that have electrical activity."
•
Key Idea/Fact: This fictional excerpt also claims the NSA maintains records on all U.S. citizens.
◦
Quote: "The NSA has records on all U.S. citizens. The NSA gathers informa-"
II. The Electrical Basis of Biological Systems:
•
Theme: The fundamental role of electricity and ion flow in the human body and brain.
•
Key Idea/Fact: "Animal Electricity" explains that biological processes at the cellular level are driven by the movement of charged ions, primarily sodium and potassium.
◦
Quote: "Since current is the fl ow of charge, the ampere needs further defi nition:" (This implies the importance of charge movement).
◦
Quote: "The electric fi eld extending around a sodium ion extends beyond the..." (Illustrates the electrical nature of ions).
•
Key Idea/Fact: The text details the hydration shells of ions in water and their role in carrying electric current.
◦
Quote: "...a sodium ion streaking through the water, within the cage formed by its fi rst hydration shell, while dragging a loosely attached plume of water molecules along, so..."
•
Key Idea/Fact: Cells maintain electrical potential differences across their membranes due to the concentration gradients and selective permeability to ions like potassium and sodium.
◦
Quote: "Because of the tremendous strength of the electric force, the transfer of potassium ions out of the cell that produces a voltage of −99 mV is very small—much too small to make a mea sur able dent in..."
•
Key Idea/Fact: Ohm's law and the concept of conductance (the reciprocal of resistance) are applicable to the flow of ions across cell membranes.
◦
Quote: "Ohm’s Law: I = Vg"
•
Key Idea/Fact: Voltage-gated channels for sodium and potassium ions are crucial for generating electrical signals in neurons, such as action potentials.
◦
The index lists "Potassium: voltage- gated channels" and "Sodium: voltage- gated channels" with numerous page references, highlighting their significance.
III. Psychological Manipulation and Control:
•
Theme: Concerns about the potential for technology and societal structures to control thoughts and behavior.
•
Key Idea/Fact: The "COSE DA PAZZI" excerpt discusses the idea of "corsi e ricorsi storici" (historical cycles) but argues that humanity's tendency to forget and its egoism drive the repetition of harmful events.
•
Key Idea/Fact: The author expresses a desire to present multiple perspectives on events to reveal "mystifications" and allow readers to form their own truths.
•
Key Idea/Fact: The text highlights the importance of conscience over reputation and criticizes media manipulation and obstruction.
◦
Quote: "E’ importante stare a posto con la propria coscienza, che è molto più importante della propria reputazione. La tua coscienza sei tu, la reputazione è ciò che gli altri pensano di te e quello che gli altri pensano di te è un problema loro."
•
Key Idea/Fact: The concept of "L'UOMO CYBORG" (Cyborg Man) is introduced, discussing the integration of technology into the human body, including implantable chips for various functions and brain-computer interfaces. This raises ethical questions about marketing influences on such technology.
◦
Quote: "La tecnologia non sarà più intorno a noi ma dentro di noi. Già oggi chip sottopelle consentono di sostituire chiavi, badge e carte di credito. Con la sola forza del pensiero, grazie a sensori a contatto con il cervello, è possibile far muovere oggetti e guidare automobili."
•
Key Idea/Fact: The excerpt touches upon the idea of mental "gabbia mentale" (mental cage) created by society and the manipulation of concepts like "freedom" and "democracy" by the "establishment."
◦
Quote: "“Nessuno è più schiavo di colui che si ritiene libero senza esserlo” Johann Wolfgang von Goethe."
•
Key Idea/Fact: The text mentions conspiracy theories about microchips for mind control but presents a counter-argument based on the lack of evidence and the technical limitations of current microchip technology. It acknowledges the existence of identification microchips for animals and experimental biochips for medical purposes.
◦
Quote: "Nella realtà esistono microchip di identificazione, che contengono in sostanza un codice che consente di identificare l'animale o la persona che li porta, e sono usati solitamente negli animali domestici per motivi di utilità (tra l'altro, per gli esseri umani non vengono più usati dal 2010)."
•
Key Idea/Fact: The excerpt briefly mentions HAARP and chemtrail conspiracy theories, debunking the claims of their use as electromagnetic weapons or for climate control, citing the low power density of HAARP's emissions.
◦
Quote: "La potenza massima sviluppata dall'impianto è di 3,6 MW (3,6 milioni di watt), che divisa per l'area colpita (55 km²), dà la potenza irrisoria di 0,07 watt per metro quadro."
•
Key Idea/Fact: The text raises concerns about the "MONARCH" and "MKUltra" programs in the context of global "mind control" efforts and discusses DARPA's research into human-machine interfaces (ElectRx program) and other advanced military technologies.
•
Key Idea/Fact: The use of drugs for weakening resistance to indoctrination and the manipulation of consciousness through substances are mentioned.
◦
Quote: «La droga indebolisce le capacità di resistenza all’indottrinamento, le facoltà difensive e le identità culturali. Crea inoltre un perfetto stato di dipendenza fisica e mentale. Per questo è stata variamente utilizzata, in differenti epoche e condizioni, come efficace strumento di condizionamento[6].»
•
Key Idea/Fact: The symbolism of the willow tree in relation to victims of programming is described.
•
Key Idea/Fact: The potential misuse of brain-reading technology (developed in Israel) for controlling behavior and enforcing societal norms is explored through hypothetical scenarios involving nanobots.
•
Key Idea/Fact: The "How to Tame a Demon" excerpt consists entirely of numbered, blank lines, suggesting a template or a structure for personal reflection or recording of experiences, without providing specific content itself.
IV. Personal Accounts of Alleged Technological Harassment and Mind Control:
•
Theme: Subjective experiences of being targeted by unknown entities using technology for harassment, manipulation, and control.
•
Key Idea/Fact: One lengthy personal account in "COSE DA PAZZI" describes experiences of ultrasonic attacks causing physical pain, demonic visions, manipulation of thoughts and emotions, and a feeling of an "electromagnetic wave" controlling their vital energy and inner world. The individual reports a loss of free will, difficulty thinking clearly, and the imposition of negative feelings and actions.
◦
Quote: "C’è in me una sensazione come un’onda elettromagnetica vicino il plesso solare e il cuore, collegata alla testa. Questa onda manipola la mia energia vitale. Questa onda sottomette la mia energia vitale e la mia anima. E ‘come un dispositivo di controllo sulla mia psiche-mente. E ‘come un falso programma di anima."
•
Key Idea/Fact: This account details alleged manipulation of perceptions, such as the sky appearing closed, and interference with attempts at verbal and emotional connection. The entity is sometimes perceived as claiming to be "God."
•
Key Idea/Fact: The individual describes struggling with the "Onda della schiavitù interiore" (Wave of Inner Slavery) that affects their sleep, breathing, thoughts, and ability for self-awareness and rational action.
•
Key Idea/Fact: Another personal account in "COSE DA PAZZI" details bizarre events and perceived harassment, including the sudden appearance of objects, strange radio messages seemingly related to their life, and a feeling of being constantly monitored and manipulated. The individual suspects the involvement of a "sacra corona" (holy crown) organization.
◦
Quote: "Ho trovato sul tavolo della cucina una base per un lume. Potrei raccontare decine di questi esempi ma al momento credo siano sufficienti questi."
•
Key Idea/Fact: This account includes allegations of being labeled paranoid and dismissed by their partner and the psychiatric system. The individual believes they are being targeted by "spies" who manipulate the "popolino" (common people) into believing their experiences are due to a medical condition.
•
Key Idea/Fact: The author claims to be a "contessa" and "duchessa" with significant inherited wealth and connections, suggesting this might be a motive for the alleged harassment and control. They list numerous prominent companies and properties they believe belong to their family.
◦
Quote: "Sono contessa dal ramo di mio nonno Alessandro Fiacchi, e duchessa dal ramo di mia nonna Annunziata Siviero..."
•
Key Idea/Fact: The text mentions coded language and symbols allegedly used by the perpetrators, including words like "ZOEK," "MOEK," and "MAC."
•
Key Idea/Fact: The author describes methods of torture using radio transmissions, emphasizing that the emotional reactions induced are a "farsa" intended to elicit orgasms from the perpetrators.
•
Key Idea/Fact: The concept of "sguinciamento" (slippage), a psychological conditioning tactic allegedly used by the "sacra corona" with radio transmissions to manipulate choices, is explained. This was reportedly investigated by Judge Falcone.
V. Directed Energy Weapons (DEWs):
•
Theme: The principles, propagation, and effects of various forms of directed energy weapons, including kinetic energy weapons, lasers, microwaves, and particle beams.
•
Key Idea/Fact: "Effects of Directed Energy Weapons" provides a technical overview of DEWs, discussing the energy required for damage, energy density and delivery rate effects, and the challenges of energy spread and loss during propagation.
◦
Quote: "The Energy Required for Damage." (This heading indicates a central theme of the text).
•
Key Idea/Fact: The book covers the fundamentals of each type of DEW, including their propagation in a vacuum and the atmosphere, their interaction with matter and targets, and potential damage mechanisms.
•
Key Idea/Fact: For lasers, the text discusses propagation phenomena like refraction, diffraction, absorption, scattering, turbulence, and nonlinear effects like thermal blooming and air breakdown. It also details laser-target interaction mechanisms such as melting, vaporization, and plasma formation.
•
Key Idea/Fact: For microwaves, the book addresses propagation losses due to atmospheric absorption and scattering, diffraction, interference, and nonlinear effects. It also covers microwave interaction with targets, including "soft kill" mechanisms affecting electronic systems and potential damage thresholds.
•
Key Idea/Fact: For particle beams, the fundamentals of charged particle dynamics, relativistic effects, and forces affecting beam propagation (electrostatic repulsion, external fields) are explained. Propagation in the atmosphere, including charge neutralization and energy losses, is also discussed.
•
Key Idea/Fact: The book uses numerous equations, figures, and tables to illustrate the physical principles and effects of DEWs, emphasizing the technical challenges and considerations involved in their development and deployment.
VI. PSI Spies and Psychic Warfare:
•
Theme: The historical reality of US psychic warfare programs and the phenomenon of remote viewing.
•
Key Idea/Fact: "PSI Spies" recounts the US government's interest and involvement in psychic phenomena for intelligence gathering, including remote viewing projects.
•
Key Idea/Fact: The excerpt provides a transcript of a remote viewing session where an individual describes a planet with "low-keyed electric magnetic splendor," suggesting the alleged ability to perceive distant locations psychically.
◦
Quote: "I’d say that the planet is characterized by sort of a low-keyed electric magnetic splendor. That’s all."
VII. MK Ritual Abuse and Mental Control:
•
Theme: The existence of alleged MK Ultra-like programs involving ritual abuse and sophisticated mind control techniques.
•
Key Idea/Fact: "MK Ritual Abuse Mental Control" discusses claims of cults and organizations practicing ritual abuse and employing advanced methods of psychological manipulation, potentially linked to government programs.
•
Key Idea/Fact: The excerpt connects these alleged practices to Luciferian doctrines and the worship of a "Mother Goddess" in opposition to "God the Father."
◦
Quote: "this is therefore a cult to the 'Mother Goddess', in opposition to God the Father (which as we have seen above is considered by this doctrine Luciferian as the 'evil god')."
VIII. Project Soul Catcher:
•
Theme: Allegations of advanced technology for brain monitoring, manipulation, and the potential capture of consciousness.
•
Key Idea/Fact: "Project Soul Catcher" (by Robert Duncan, who also authored "How to Tame a Demon") suggests the existence of sophisticated technologies aimed at understanding and influencing the human brain.
•
Key Idea/Fact: The excerpt refers to "terminator programs," "Thought and Memory Interface," and "thought filtering," hinting at advanced capabilities for controlling mental processes.
•
Key Idea/Fact: The text mentions techniques like "sensitization methods," cloning smells and tastes, and the use of hypnosis and "SATAN" (a detrimental thought technology) to influence targets.
•
Key Idea/Fact: The index of "Project Soul Catcher" lists terms like "torture" with numerous page references, suggesting a significant aspect of the alleged program.
Overall Observations and Potential Connections:
•
The sources present a wide spectrum of ideas, ranging from technical explanations of electromagnetic phenomena and biological electricity to fictional portrayals of advanced surveillance and highly subjective personal accounts of technological harassment and mind control.
•
There is a tension between the technical realities of directed energy weapons and microchip technology as described in "Effects of Directed Energy Weapons" and the more speculative and conspiratorial claims found in other sources like "COSE DA PAZZI," "MK Ritual Abuse Mental Control," and "Project Soul Catcher."
•
The personal accounts in "COSE DA PAZZI" resonate with some of the themes and alleged technologies discussed in the more conspiratorial sources, such as the use of electromagnetic waves, ultrasonic frequencies, and mind manipulation. However, these accounts are presented without external corroboration and should be considered within the context of subjective experience.
•
The inclusion of excerpts from a novel ("1996") highlights the blurring of lines between fiction and purported reality in discussions surrounding surveillance and technology.
•
The reference to historical events like Judge Falcone's investigations suggests an attempt to ground the more extreme claims within a historical context, albeit one that is then intertwined with allegations of ongoing conspiracies.
•
The blank lines in "How to Tame a Demon" serve as a stark contrast to the detailed (though sometimes technically dense or conspiratorial) content of the other sources, perhaps inviting a personal and less structured engagement with the themes of control and manipulation.
This briefing document provides a preliminary overview of the complex and often contradictory information presented in the provided sources. Further analysis would require a deeper examination of each source individually and in relation to established scientific knowledge and documented historical events.
--------------------------------------------------------------------------------
Surveillance, Mind Control, and Targeted Effects
Questions
•
What evidence from the provided sources suggests the existence and capabilities of advanced surveillance and intelligence gathering technologies? The excerpts from Gloria Naylor's "1996. A novel" explicitly state that the NSA/DoD has developed "proprietary advanced digital equipment" capable of remotely analyzing all objects with electrical activity, whether man-made or organic, through the detection of EMF waves. It further claims that the NSA maintains records on all U.S. citizens. The "COSE DA PAZZI.pdf" document also mentions Signals Intelligence being based on the principle that anything with an electric current emits EMF waves, which can be remotely analyzed. These points collectively suggest a belief in the existence of highly sophisticated technologies for pervasive surveillance.
•
According to "Animal Electricity," how does the body generate and utilize electricity at a cellular level? "Animal Electricity" details how cells function as miniature batteries, primarily through the movement of ions like sodium and potassium across their membranes. These ions, surrounded by hydration shells of water molecules, create electrical currents and voltage differences. The selective permeability of cell membranes and the concentration gradients of these ions drive the flow of charge, which is essential for nerve impulses and other physiological processes. Ohm's law (I=Vg) is applicable at this level, with ionic conductance (g) being the reciprocal of resistance. The voltage produced by even a small series of these cellular "batteries" can be significant, comparable to that of a standard AA battery.
•
What are "directed energy weapons" (DEWs) as described in the "Effects of Directed Energy Weapons" excerpt, and what are some of their fundamental principles? The "Effects of Directed Energy Weapons" excerpt defines DEWs as weapons that damage targets with concentrated electromagnetic energy or kinetic energy. The fundamental principles discussed include the energy required for damage, the significance of energy density and delivery rate, and how energy spreads and loses intensity during propagation through different media like vacuum and the atmosphere. The text covers various types of DEWs, including kinetic energy weapons, lasers, microwaves, and particle beams, detailing their propagation characteristics and interaction with matter.
•
How do the sources discuss the concept of mind control, and what technologies or methods are implicated? The sources present differing perspectives on mind control. "COSE DA PAZZI.pdf" and the excerpt from Gloria Naylor's novel suggest the possibility of mind control through advanced technologies, including microchips, electromagnetic waves, and the manipulation of thoughts. "COSE DA PAZZI.pdf" also mentions "Project MONARCH and MKUltra" in the context of a global "mental control" agenda. In contrast, the CEIFAN section within "COSE DA PAZZI.pdf" dismisses microchip-based mind control as a "delirious hoax." "Project Soul Catcher" delves into techniques for influencing thoughts and behaviors, mentioning methods like "sensitization," subliminal messaging ("the voice of god"), and the manipulation of sensory experiences. The "Effects of Directed Energy Weapons" discusses the potential of microwaves and lasers to interact with biological systems, including causing neurological effects at high intensities.
•
What are the potential societal and ethical implications raised by the development and use of technologies that can interact with or influence the human body and mind, according to these sources? Several ethical and societal concerns emerge. "COSE DA PAZZI.pdf" raises the risk of technologies modifying human biology being driven by marketing logic. "Project Soul Catcher" hints at the potential for misuse of mind-influencing techniques. The fictional excerpt from "1996. A novel" suggests concerns about privacy and government overreach through surveillance. The discussion of DEWs in "Effects of Directed Energy Weapons" brings up the ethical considerations of using such powerful and potentially non-lethal (but still harmful) weapons. "COSE DA PAZZI.pdf" also touches upon the erosion of freedom and the manipulation of public opinion in democratic societies.
•
How do the personal accounts in "COSE DA PAZZI.pdf" describe the alleged experiences of targeted individuals, and what technologies or phenomena are associated with these experiences? The personal accounts in "COSE DA PAZZI.pdf" describe disturbing experiences attributed to organized harassment and technological interference. These include constant surveillance, manipulation of the environment, and alleged targeting with "radio-transmitters" causing physical sensations, emotional distress, and cognitive disruption. The narrative mentions phenomena like "micro wave hearing" (voice transmission through the brain) and the use of "ultrasounds." The targeted individual describes a sense of being controlled and subjected to psychological torture, along with the perception of a broader network of individuals involved in these activities.
•
What role do conspiracy theories and skepticism play in the discussion of these topics across the provided sources? Conspiracy theories are a significant undercurrent in several sources. "COSE DA PAZZI.pdf" explicitly discusses conspiracy theories related to microchip mind control, HAARP, and chemtrails, often presenting a skeptical view towards them, particularly the microchip claims. However, the personal accounts within the same document imply a belief in a large-scale conspiracy involving technological harassment. The excerpt from Gloria Naylor's novel, being fictional, touches on themes that often feature in conspiracy narratives about government surveillance. "PSI Spies" details a real psychic warfare program, which could be seen as bordering on or inspiring conspiracy theories. The text on HAARP in "COSE DA PAZZI.pdf" directly addresses and debunks common conspiracy theory claims with scientific reasoning.
•
How do the sources touch upon the concepts of perception, reality, and manipulation in the context of technology and alleged targeting? The sources highlight the subjective nature of perception and how it can be manipulated. The personal account in "COSE DA PAZZI.pdf" describes a reality seemingly altered by external forces, leading to confusion and distress. "Project Soul Catcher" explicitly focuses on techniques to manipulate perception and thought. The CEIFAN's dismissal of mind control chips in "COSE DA PAZZI.pdf" emphasizes the difference between technological reality and conspiratorial beliefs. The "Mentalismo" section in "COSE DA PAZZI.pdf" discusses psychological techniques to "read minds" by observing subtle cues, highlighting how perceptions of others can be influenced. The narrative of the targeted individual in "COSE DA PAZZI.pdf" struggles to distinguish between genuine experiences and potential psychological effects, illustrating the complexities of perceived reality under alleged technological targeting.
--------------------------------------------------------------------------------
Holographic Brain and Resonance in Neural Function
...
--------------------------------------------------------------------------------
Brain Holography and Resonance: Information Processing
Based on the sources, there is support for the idea of holographic models being relevant to the structure and processing of information in the brain, including sensory information and potentially memory, and the concept of resonance playing a role in brain function and communication. However, the sources do not explicitly state that "holographic resonance" is the fundamental structure of human memories.
Here's a breakdown of the relevant information:
•
Holographic Models of the Brain and Sensory Processing:
◦
Soviet researchers in the 1960s attempted to construct holographic models of the brain [1, 2].
◦
Karl Pribram suggested that sensory information is relayed in bits and pieces and reconstructed by neuron interaction, and that sensory cells can interact to form interference patterns typical of a hologram [1-3]. He spent much of his career documenting this holographic model of the human brain [4].
◦
Holography is described as a method of lensless photography where the wave field of light scattered by an object is recorded as an interference pattern, and when a coherent light beam is passed through the hologram, a three-dimensional image appears [4]. A key feature is that any piece of the hologram can reconstruct the entire image [4].
◦
David Bohm suggested that the hologram is a starting point for a new description of reality, the "enfolded order" [4].
◦
Marilyn Ferguson stated that our brains mathematically construct "hard" reality by interpreting frequencies from a dimension transcending time and space, suggesting that the brain is a hologram [4].
◦
The brain utilizes Fourier mathematics, the same mathematics employed by holography, to convert visual images into the Fourier language of wave forms [4]. The brain's visual cortex responds to the frequencies of various wave forms [4].
◦
The human ear is a frequency analyzer, and our skin is sensitive to frequencies of vibrations [4].
◦
Pribram's theory suggests that sensory information is relayed and reconstructed by neuron interaction and that sensory cells can interact to form a type of hologram made up of electromagnetic waves [3].
•
Resonance in Brain Function and Memory:
◦
The brain might have a high Q factor for its micro and macro circuitry, meaning it can act like a mobile phone in terms of reception and amplification of signals [5].
◦
Resonance is described as a phenomenon where energy can be added to targeted parts of the body and atoms of interest [5].
◦
The concept of a "brain resonance" or a state that was achieved is mentioned, with these resonances represented as templates that can be replayed into a target mind [6].
◦
Pulsed ion cyclotron resonance heating signals are used as a way to "ping" the brain to see if there's an open port for further hacking, in the context of military applications [7].
◦
The frequencies of brains involved in a "cybernetic hive mind" can be phase, frequency, and amplitude modulated to bring them to a state where information exchange is easier [8].
◦
Remote Neural Monitoring (RNM) requires decoding the resonance frequency of each specific brain area [9]. This frequency is then modulated to impose information [9]. Each person's brain has a unique set of bioelectric resonance/entrainment frequencies [10].
•
Acoustic Holography:
◦
In a patent described in one source, a signal generator converts neural firing time differences to a first signal, which "may comprise an acoustical pattern... accomplished by using known techniques in generating projective holograms" [11]. This relates to acoustic holography, where amplitude and phase differences create a pattern [11].
While these sources indicate that holographic principles are considered relevant to how the brain processes sensory information and that resonance phenomena are involved in brain function and communication, there is no direct statement claiming that "holographic resonance" is the fundamental structure of human memories. Pribram's work suggests a holographic nature to sensory processing, and resonance is seen as a way to interact with brain activity, but the explicit link to the fundamental structure of all memories in this combined form is not explicitly made within these sources.
It's important to note that the nature of memory storage is still an area of active research. While the sources discuss memory as being stored in networks of neurons [12] and the strengthening of synapses [12, 13], and even mention molecular mechanisms of learning [13] and long-term potentiation in the hippocampus [13, 14], the holographic model provides a different perspective on how information might be distributed and accessed within the brain.
Therefore, while the sources provide intriguing connections between holographic models and brain function, and highlight the role of resonance in neural processes, you would need to consult further research beyond these sources to definitively establish "holographic resonance" as the fundamental structure of human memories.
--------------------------------------------------------------------------------
Holography and Virtual Reality: Immersive Sensory Technologies
...
--------------------------------------------------------------------------------
Digital Encoding, Thought Reading, and Brain Mechanisms
...
--------------------------------------------------------------------------------
Electromagnetic Induction of Body Movements
...
--------------------------------------------------------------------------------
Psychotronic Weapons: Remote Manipulation and Non-Covert Torture
...
--------------------------------------------------------------------------------
CIA, Mafia, and Italian Secret Service Links
...
--------------------------------------------------------------------------------
Media Control and Mass Intellect Suppression
...
--------------------------------------------------------------------------------
Gangstalking, UFOs, and Forced Dissociation: Intertwined Phenomena
...
--------------------------------------------------------------------------------
Nina Kulagina and the Thresher Submarine Rumor
...
--------------------------------------------------------------------------------
Psychic Powers in Psychological Warfare: A Cold War Focus
...
--------------------------------------------------------------------------------
Classified Neuroscience: Government Control and Research Disparity
...
--------------------------------------------------------------------------------
AI and the Specter of Mass Mind Control
...
--------------------------------------------------------------------------------
Transhumanism and Mind Control: Converging Technologies, Divergent Ethics
...
--------------------------------------------------------------------------------
Transhumanism: Core Concepts, Technology, and Ethical Debates
...
--------------------------------------------------------------------------------
EMF Exposure: Cancer Risks and Scientific Suppression
...
--------------------------------------------------------------------------------
Psychotronic Sects: Mind Control and Secret Agendas
...
--------------------------------------------------------------------------------
Targeted Individuals: Beliefs on Brain Mapping and Mind Control
...
--------------------------------------------------------------------------------
European Union Stance on Human Mind Control Technologies
...
--------------------------------------------------------------------------------
Soviet Bioweapons Program: The Biopreparat Era
...
--------------------------------------------------------------------------------
Russian Psychotronic Tech: Post-Soviet Privatization and Control
...
--------------------------------------------------------------------------------
Nazi Influence on US Intelligence and Mind Control
...
--------------------------------------------------------------------------------
Electromagnetic Fields, Mind Influence, and Surveillance Technologies
...
The concept of "electromagnetic spam" is not explicitly defined as such in the sources. However, the idea of widespread electromagnetic emissions with potential biological effects is present. For example, the Russian "Woodpecker" signal, a powerful man-made EMR source of the 40 million watts per pulse [21], is described as permeating everything in the U.S. and being irradiated into homes via power grids [21]. Similarly, concerns about the potential for HAARP's signals to have widespread and even harmful effects are raised [20, 22]. The idea of high-definition TVs and computer monitors emitting pulsed electromagnetic fields of sufficient amplitudes to manipulate the nervous system [23] could also be considered a form of ambient "electromagnetic noise" with potential bioeffects.
...
--------------------------------------------------------------------------------
Brain Imaging, Government Research, and Bioeffects
...
•
Electron Spin Resonance (ESP): One source [36] mentions ELF (extremely low frequency) waves turning the target's environment into an NMR (nuclear magnetic resonance) and ESP (electron and free radical spin resonance) machine to increase the signal-to-noise ratio at Earth's Gauss levels for remote targeting. This suggests that electron spin resonance, along with other electromagnetic phenomena, is considered relevant in the context of technologies that could interact with biological systems at a distance.
•
...
--------------------------------------------------------------------------------
The Absurdity Factor in Secret Weapons Program Disbelief
...
--------------------------------------------------------------------------------
Weapon Nomenclature: Obscuring Reality and Intent
...
--------------------------------------------------------------------------------
Torture and Dream Manipulation
...
--------------------------------------------------------------------------------
Mind Control: Manchurian Candidate and Monarch Program
...
--------------------------------------------------------------------------------
Motivations, Threats, and Control in Alleged Mind Control Programs
...
--------------------------------------------------------------------------------
Mind Control, AI, and the Emerging Hive Mind
...
--------------------------------------------------------------------------------
Estimating Non-Consensual Torture Victims: Challenges and Claims
...
--------------------------------------------------------------------------------
Nonconsensual Experiments: Nuremberg Principles and Accountability Challenges
...
--------------------------------------------------------------------------------
Government Origins of Human Conditioning Programs
...
--------------------------------------------------------------------------------
Targeted Individuals, Psionics, and UFO Connections
...
--------------------------------------------------------------------------------
Reported Physical Abuses Against Targeted Individuals
...
--------------------------------------------------------------------------------
Targeted Individuals: Harassment and Torture Tactics
...
--------------------------------------------------------------------------------
China's New-Concept Weapons and Brain Effects
...
--------------------------------------------------------------------------------
Covert Mind Control Programs: US, Russia, and Beyond
...
--------------------------------------------------------------------------------
History of Psychotronic Weapons and Devices
...
--------------------------------------------------------------------------------
Government Mind Control: Goals and Tactics
